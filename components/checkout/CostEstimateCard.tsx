...
export default function CostEstimateCard({ estimate, isLoading }: Props) {
  if (isLoading) {
    return (
      <Animated.View
  ...
  return (
    ...
    >
      <Text className="text-sm font-medium text-neutral-500">Coûts estimés</Text>
      ...
      <View className="mt-4 space-y-3">
        ...
        {/* DELIVERY BETWEEN min-max */}
        <Row
          label={`Livraison`}
          value={`${formatCurrency(500)} ou plus`}
        />

        {/* 
        ✅ TOTAL — Commenté mais conservé proprement
